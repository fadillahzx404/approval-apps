{{-- Change BG --}}
@php
    $bg_change = 'text-gray-900 font-bold bg-gradient-to-r from-red-400 from-35% to-blue-500 to-80% shadow-md';
    $hover = 'hover:scale-90 duration-300 transition-all hover:bg-blue-100';
@endphp
{{-- Menu 1 --}}
<div class="space-y-3 ">
    ...
    <ul class="space-y-3">
        <li>
            ...
            <a class="flex items-center px-3 py-2 font-regular rounded-md {{ $hover }} {{ request()->is('dashboard') ? $bg_change : '' }}"
                href="#">
        ...
        <li>
            <a class="flex items-center px-3 py-2 rounded-md {{ $hover }}" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span class="mx-2 text-sm ">Preformance</span>
            </a>
        </li>
    </ul>
</div>
...
<div class="space-y-3 ">
    ...
    <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
        ...
        <span class="mx-2 text-sm ">Guides</span>
    </a>
    ...
    <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
        ...
        <span class="mx-2 text-sm ">Hotspots</span>
    </a>
    ...
    <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
        ...
        <span class="mx-2 text-sm ">Checklists</span>
    </a>
</div>
...
<div class="space-y-3 ">
    ...
    <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
        ...
        <span class="mx-2 text-sm ">Themes</span>
    </a>
